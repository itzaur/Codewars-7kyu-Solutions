...
const countCombinations = (string, key) => {
  ...
  //////////////////////////////////////!SECTION
  //   return --string.split(RegExp(key, 'i')).length;
};
...
console.log(
  countCombinations(
    'This is a really long string with no intention of being short and a run on sentence is a run on sentence any way you look at it, split it, cut it, paste it, melt it, and beat it.',
    'it'
  )
); //8
console.log(
  countCombinations(
    'Words are inside words that are on the outside of walls to the side of the bedside.',
    'side'
  )
); //4
