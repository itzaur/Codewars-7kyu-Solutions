...
function quadrantSegment(A, B) {
  return (A.x > 0 && A.y > 0 && B.x > 0 && B.y > 0) ||
    ...
    : true;
  //////////////////////////////////////////!SECTION
  //   return A.x * B.x > 0 && A.y * B.y > 0 ? false : true;
}

console.log(new Coord(1, 2), new Coord(3, 4)); //false
console.log(new Coord(9, 3), new Coord(-1, 6)); //true
console.log(new Coord(-1, 6), new Coord(-9, 1)); //false
