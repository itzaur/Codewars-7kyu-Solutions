...
function uncensor(infected, discovered) {
  ...
  return infected.replace(/[*]/g, () => discovered[index++]);
  ////////////////////////////////////////!SECTION
  //   const arr = [...discovered];
  //   return infected.replace(/\*/g, (_) => arr.shift());
  ////////////////////////////////////////!SECTION
  //   const arr = [...discovered];

  //   return [...infected].map((el) => (el === '*' ? arr.shift() : el)).join('');
  ////////////////////////////////////////!SECTION
  //   return [...discovered].reduce((acc, el) => acc.replace('*', el), infected);
}
...
console.log(uncensor('', '')); //''
console.log(uncensor('***', 'abc')); //'abc'
