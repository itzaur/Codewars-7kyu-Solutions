...
function falsyOrTruthy(arr) {
  return !(arr.length % 2) ? arr.filter((el) => el) : arr.filter((el) => !el);
}

console.log(falsyOrTruthy([false, NaN, NaN, 4, 5, {}])); //[4,5,{}]
console.log(falsyOrTruthy([false, NaN, NaN, 4, 5, 1, {}])); //[false,NaN,NaN]
