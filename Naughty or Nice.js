...
function naughtyOrNice(data) {
  ...
  const niceCount = string.split('Nice').length;
  const naughtyCount = string.split('Naughty').length;

  return niceCount >= naughtyCount ? 'Nice!' : 'Naughty!';
  //////////////////////!SECTION
  //   let count = Object.values(data).reduce(
  //     (c, m) => (Object.values(m).forEach((v) => c[v]++), c),
  //     { Naughty: 0, Nice: 0 }
  //   );
...
//   ((str) =>
//     str.match(/Nice/g).length < str.match(/Naughty/g).length
//       ? `Naughty!`
//       : `Nice!`)(JSON.stringify(data));
