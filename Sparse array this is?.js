...
Array.prototype.isSparse = function () {
  ...
  //////////////////////////////////////!SECTION
  //   return this.length != this.filter((el) => el == el).length;
  //////////////////////////////////////!SECTION
  //   return this.reduce(sum => ++sum , 0) < this.length
};
...
console.log(!array1.isSparse()); //msg1
console.log(array2.isSparse()); //msg2
