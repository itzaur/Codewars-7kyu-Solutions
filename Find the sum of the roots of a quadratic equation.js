...
function roots(a, b, c) {
  ...
  return !Number.isNaN(x1) || !Number.isNaN(x2)
    ? Math.round((x1 + x2) * 100) / 100
    : null;
  ////////////////////////////////!SECTION
  //   return b ** 2 - 4 * a * c < 0 ? null : Math.round((-b / a) * 1e2) / 1e2;
}
...
console.log(roots(1, 6, 12)); //null
console.log(roots(1, 0, -9)); //0
console.log(roots(-3, 0, 12)); //0
console.log(roots(1, 3, 9)); //null
console.log(roots(3, 7, 0)); //-2.33
console.log(roots(5, 3, 6)); //null
