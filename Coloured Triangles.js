...
function triangle(row) {
  ...
  // return row.length > 1
  //   ? triangle(
  //       [...row].slice(1).reduce((acc, el, i) => {
  //         return el !== row[i]
  //           ? acc + "RGB".replace(el, "").replace(row[i], "")
  //           : acc + el;
  //       }, "")
  //     )
  //   : row;
...
console.log(triangle("RRG")); //G
console.log(triangle("BGR")); //G
...
console.log(triangle("R")); //'R'

console.log("absfr".slice(1));
