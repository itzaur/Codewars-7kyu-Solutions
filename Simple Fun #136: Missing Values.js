...
function missingValues(arr) {
  ...
  const x = arr.filter((el) => occurrences[el] === 1)[0];
  const y = arr.filter((el) => occurrences[el] === 2)[0];
...
console.log(
  missingValues([
    66, 4, 80, 66, 4, 83, 97, 81, 19, 4, 80, 51, 83, 81, 83, 66, 51, 80, 97, 81,
    97,
  ])
); //18411
console.log(
  missingValues([
    60, 76, 86, 76, 86, 53, 60, 88, 71, 71, 71, 86, 88, 76, 88, 17, 60, 26, 17,
    17, 26, 53, 98, 53,
  ])
); //249704
console.log(
  missingValues([
    42, 23, 45, 33, 33, 19, 42, 79, 79, 23, 95, 95, 79, 19, 42, 33, 19, 23,
  ])
); //192375
console.log(
  missingValues([
    4, 74, 41, 41, 41, 88, 63, 35, 35, 4, 88, 13, 63, 74, 63, 88, 4, 74,
  ])
); //5915
