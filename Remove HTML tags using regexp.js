...
*/
String.prototype.replace = function (reg, replacement) {
  return this.split(reg).join(replacement);
};
const reg = /<[^>]+>/g;
//////////////////////////////!SECTION
// var reg = /<.+?>/g;
...
console.log(
  '<p>first section<b>bold text</b>second part    </p>'.replace(reg, ''),
); //"first sectionbold textsecond part    "
console.log('<div>text\ntext <span>2</span></div>'.replace(reg, '')); //"text\ntext 2"
console.log(
  "<html lang = 'pl' ><body>content of body ... </body> ... </html>".replace(
    reg,
    '',
  ),
); //"content of body ...  ... "
