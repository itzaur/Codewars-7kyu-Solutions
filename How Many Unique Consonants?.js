...
function countConsonants(str) {
  return [...new Set(str.toLowerCase().replace(/[aeiou]|[0-9]|[!&?$* ]/gi, ''))]
    .length;

  //   return new Set(str.toLowerCase().replace(/[^a-z]|[aeiou]/g, ``)).size;

  //   return (str.match(/([^aeiou\W\d_])(?!.*\1)/gi) || []).length;
}

console.log(countConsonants('sillystring')); //7
console.log(countConsonants('0Vr3I')); //2
console.log(countConsonants('nyYQO')); //3
